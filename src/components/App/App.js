    ...
    <div className="app-root">
      <div className="app-header">
        ...
        <div className="d-flex justify-content-center flex-wrap mb-3 mt-3" style={{minWidth:"100px"}}>
          ...
          <input className="app-input mb-1" placeholder={(location.current && !'No filter') ? "" : "Showing most recent photos"} onChange={(event) => handleInputChange(event)} value={inputValue} />
